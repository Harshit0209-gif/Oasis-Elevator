    ...
    <div className="grid grid-cols-1 items-center gap-10 border-b border-hairline py-16 md:grid-cols-2 md:gap-16 md:py-24 last:border-b-0">
      ...
      >
        <OptimizedImage
          ...
          containerClassName="aspect-[4/3] w-full rounded-sm"
      ...
      >
        ...
        <GoldDivider />
        <h3 className="text-balance font-heading text-3xl font-medium leading-tight text-foreground md:text-4xl lg:text-5xl">
          {feature.title}
        </h3>
