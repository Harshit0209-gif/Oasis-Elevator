...
export function TrustIndicators() {
  return (
    <section className="border-y border-hairline bg-bg-secondary">
      <div className="container-oasis grid grid-cols-2 divide-x divide-y divide-hairline py-14 md:grid-cols-5 md:divide-y-0">
        {stats.map((stat, index) => (
          ...
          >
            <p className="text-4xl font-medium text-bg-light md:text-5xl">
