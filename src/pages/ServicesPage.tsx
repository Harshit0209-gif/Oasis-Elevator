import { Check, HardHat, Wrench, RefreshCw } from "lucide-react";
...
const icons: Record<string, typeof HardHat> = {
  "erection-new-installation": HardHat,
  "maintenance-repair-service": Wrench,
  "modernization-renovation": RefreshCw,
};
...
export function ServicesPage() {
  return (
    <>
      <Seo
        title="Services"
        description="End-to-end elevator services — erection & new installation, maintenance & repair, and modernization & renovation."
        path="/services"
      />
      <PageHero
        eyebrow="Services"
